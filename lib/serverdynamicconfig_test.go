...
func addIdentities(t *testing.T, notadmin, admin *Identity, srv *Server) {
	...
	_, err = notadmin.UpdateServerConfig(&api.UpdateConfigRequest{
		Update: []string{"add", "registry.identities={\"id\": \"testuser1\", \"secret\": \"testpass\", \"type\": \"user\", \"max_enrollments\": 5, \"attrs\": [{\"name\": \"hf.Revoker\", \"value\": \"false\"}]}"},
	})
	...
	resp, err := admin.UpdateServerConfig(&api.UpdateConfigRequest{
		Update: []string{"add", "registry.identities={\"id\": \"testuser1\", \"secret\": \"testpass\", \"type\": \"user\"}", "add", "registry.identities={\"id\": \"testuser2\", \"secret\": \"testpass\", \"type\": \"user\"}"},
	})
