...
var _ = Describe("user", func() {
	...
	Context("get new attributes", func() {
		...
		It("modifies existing attributes", func() {
			...
			Expect(attrs).To(Equal([]api.Attribute{api.Attribute{"attr1", "attr1_newvalue", false}}))
		})
		...
		It("add attributes if not found", func() {
			...
			attrs := user.GetNewAttributes(modifyAttributes, newAttributes)
			Expect(attrs).To(Equal([]api.Attribute{api.Attribute{"attr1", "attr1_value", false}, api.Attribute{"attr2", "attr2_value", false}}))
		})
