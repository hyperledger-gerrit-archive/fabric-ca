...
//go:generate counterfeiter -o mocks/dbMigrator.go -fake-name DBMigrator . DBMigrator
...
func Migrate(migrator DBMigrator, currentLevels, srvLevels *util.Levels) error {
