...
func (fake *Sqlx) MustBegin() *sqlx.Tx {
...
func (fake *Sqlx) MustBeginReturnsOnCall(i int, result1 *sqlx.Tx) {
	fake.mustBeginMutex.Lock()
	defer fake.mustBeginMutex.Unlock()
	fake.MustBeginStub = nil
...
func (fake *Sqlx) SetMaxOpenConns(arg1 int) {
