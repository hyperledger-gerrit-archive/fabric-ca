...
func (h *RevokeRequestHandler) revokeID(req *api.RevocationRequest) ([]string, error) {
	...
	return h.revokeByName(req, user)
}

// RevokeByName revokes Idemix credential based on enrollment id
...
func (h *RevokeRequestHandler) revokeByName(req *api.RevocationRequest, user spi.User) ([]string, error) {
	reason := util.RevocationReasonCodes[req.Reason]
