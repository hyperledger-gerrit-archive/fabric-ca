...
type RevocationKey interface {
	...
	// Creates new revocation public and private key pair and sets them in this object
	NewKey() error
}
...
// NewKey creates new revocation key
func (rk *caIdemixRevocationKey) NewKey() error {
	var err error
