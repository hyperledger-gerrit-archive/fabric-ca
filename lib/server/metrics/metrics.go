...
var (
	...
	APICounterOpts = metrics.CounterOpts{
		...
		LabelHelp: map[string]string{
			"api_name":    "example api_names: affiliations/{affiliation}, affiliations, certificates, enroll, reenroll, gencrl, idemix/cri, identities, register, revoke, tcert,  idemix/credential, identities/{id}. ",
			"status_code": "Http status code. https://www.restapitutorial.com/httpstatuscodes.html",
		},
