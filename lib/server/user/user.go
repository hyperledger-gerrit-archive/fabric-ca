...
// UserImpl is the databases representation of a user
...
func New(userRec *Record, db userDB) *UserImpl {
...
func (u *UserImpl) GetMaxEnrollments() int {
	return u.MaxEnrollments
}

// GetLevel returns the level of the user
func (u *UserImpl) GetLevel() int {
	return u.Level
}

// SetLevel sets the level of the user
func (u *UserImpl) SetLevel(level int) error {
	return u.setLevel(nil, level)
}

// SetLevelTx sets the level of the user
func (u *UserImpl) SetLevelTx(tx userDB, level int) error {
	return u.setLevel(tx, level)
}

func (u *UserImpl) setLevel(tx userDB, level int) (err error) {
...
// Login the user with a password
func (u *UserImpl) Login(pass string, caMaxEnrollments int) error {
...
func (u *UserImpl) resetIncorrectLoginAttempts() error {
...
// LoginComplete completes the login process by incrementing the state of the user
func (u *UserImpl) LoginComplete() error {
...
func (u *UserImpl) GetAffiliationPath() []string {
	affiliationPath := strings.Split(u.Affiliation, ".")
	return affiliationPath
}

// GetAttribute returns the value for an attribute name
func (u *UserImpl) GetAttribute(name string) (*api.Attribute, error) {
...
func (u *UserImpl) GetAttributes(attrNames []string) ([]api.Attribute, error) {
	var attrs []api.Attribute
	if attrNames == nil {
...
// IsRevoked returns back true if user is revoked
func (u *UserImpl) IsRevoked() bool {
	if u.State == -1 {
		return true
	}
	return false
...
func (u *UserImpl) ModifyAttributesTx(tx userDB, newAttrs []api.Attribute) error {
...
func (u *UserImpl) ModifyAttributes(newAttrs []api.Attribute) error {
	return u.modifyAttributes(nil, newAttrs)
}

func (u *UserImpl) modifyAttributes(tx userDB, newAttrs []api.Attribute) error {
...
// IncrementIncorrectPasswordAttempts updates the incorrect password count of user
func (u *UserImpl) IncrementIncorrectPasswordAttempts() error {
...
func (u *UserImpl) migrateUserToLevel1(tx userDB) error {
...
func GetUserLessThanLevel(tx userDB, level int) ([]*UserImpl, error) {
	if level == 0 {
		return []*UserImpl{}, nil
	}
