...
func (d *Accessor) GetAllAffiliations(name string) ([]spi.Affiliation, error) {
	...
	var baseAffiliation AffiliationRecord
	var affiliations []AffiliationRecord
	...
	if name == "" { // Requesting all affiliations
		...
		affiliation := spi.NewAffiliation(baseAffiliation.Name, baseAffiliation.Prekey, baseAffiliation.Level)
