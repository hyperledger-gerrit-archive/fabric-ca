...
// GetAllAttributes returns the all attributes of the user
func (u *DBUser) GetAllAttributes() []api.Attribute {
	var attrs []api.Attribute
...
// SetAttributes adds a new attribute or modifies existing attribute of the user
func (u *DBUser) SetAttributes(attrs []api.Attribute) error {
	log.Debugf("Set Attributes: %+v", attrs)
	userAttrs := u.GetAllAttributes()
