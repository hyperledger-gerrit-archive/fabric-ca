...
func (tm *Mgr) GetBatch(req *api.GetTCertBatchRequest, ecert *x509.Certificate) (*api.GetTCertBatchResponse, error) {
...
func generateExtensions(tcertid *big.Int, tidx []byte, enrollmentCert *x509.Certificate, batchRequest *api.GetTCertBatchRequest) ([]pkix.Extension, map[string][]byte, error) {
