...
func TestMetricsE2E(t *testing.T) {
	...
	gt.Expect(datagramReader.String()).Should(ContainSubstring("server.api_request.count.ca.enroll.201:1.000000|c"))
	gt.Expect(datagramReader.String()).Should(ContainSubstring("server.api_request.count.ca.enroll.401:1.000000|c"))
	gt.Expect(datagramReader.String()).Should(ContainSubstring("server.api_request.duration.ca.enroll.401"))
