...
func TestStatsdMetricsE2E(t *testing.T) {
	...
	gt.Expect(contents).Should(ContainSubstring("server.api_request.duration.ca.enroll.401"))
	gt.Expect(contents).Should(ContainSubstring("server.api_request.count.ca.enroll.401:1.000000|c"))
}
