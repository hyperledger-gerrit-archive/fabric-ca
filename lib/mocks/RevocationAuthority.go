...
func (_m *RevocationAuthority) GetNewRevocationHandle() (*lib.RevocationHandle, error) {
	ret := _m.Called()

	var r0 *lib.RevocationHandle
	if rf, ok := ret.Get(0).(func() *lib.RevocationHandle); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*lib.RevocationHandle)
		}
	}
