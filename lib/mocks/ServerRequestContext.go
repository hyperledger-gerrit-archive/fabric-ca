...
import db "github.com/hyperledger/fabric-ca/lib/db"
...
func (_m *ServerRequestContext) GetCertificates(_a0 db.CertificateRequest, _a1 string) (*sqlx.Rows, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *sqlx.Rows
	if rf, ok := ret.Get(0).(func(db.CertificateRequest, string) *sqlx.Rows); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(db.CertificateRequest, string) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
