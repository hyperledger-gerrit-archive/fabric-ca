...
import userregistry "github.com/hyperledger/fabric-ca/lib/server/userregistry"
...
func (_m *ServerRequestContext) GetCaller() (userregistry.User, error) {
	ret := _m.Called()

	var r0 userregistry.User
	if rf, ok := ret.Get(0).(func() userregistry.User); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(userregistry.User)
		}
	}
