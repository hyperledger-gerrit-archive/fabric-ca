...
func registerUserID(req *api.RegistrationRequest, ca *CA) (string, error) {
	...
	// already defined
	addAttributeToRequest(attrEnrollmentID, req.Name, req)
	addAttributeToRequest(attrType, req.Type, req)
	addAttributeToRequest(attrAffiliation, req.Affiliation, req)
