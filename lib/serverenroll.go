...
func handleEnroll(ctx *serverRequestContextImpl, id string) (interface{}, error) {
	...
	if err != nil {
		return nil, caerrors.NewHTTPErr2(err, 404, 1000, "Failed to find attribute")
	}
...
func processSignRequest(id string, req *signer.SignRequest, ca *CA, ctx *serverRequestContextImpl) error {
	...
	if err != nil {
		return caerrors.NewHTTPErr2(err, 400, caerrors.ErrInputValidCSR, "CSR input validation failed")
	}
