...
// GetName returns the user's distiguished name
func (u *user) GetName() string {
	return u.entry.DN
}

// GetEnrollmentID returns the user's enrollment ID (ID used by the user to get enrollment certificate)
func (u *user) GetEnrollmentID() string {
	return u.name
}
