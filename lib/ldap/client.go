...
func (lc *Client) DeleteUser(id string) (interface{}, error) {
...
func (lc *Client) GetAllAffiliations(name string) ([]spi.Affiliation, error) {
	return nil, errNotSupported
}
...
func (lc *Client) DeleteAffiliation(name string, force, identityRemoval bool) (interface{}, error) {
	return nil, errNotSupported
}
