...
func (ac *attributeControl) validateListAttribute(requestedAttr *api.Attribute, callersAttrValue string, allRequestedAttrs []api.Attribute, user AttributeControl) error {
	...
	// requested attribute names as values to this attribute to make sure caller is allowed register
	...
	// If requested hf.Registrar.DeletegateRoles make sure it is equal or a subset of the user's hf.Registrar.Roles attribute
...
func canRegisterAttr(requestedAttrValue string, callerRegisterAttrSlice []string) error {
