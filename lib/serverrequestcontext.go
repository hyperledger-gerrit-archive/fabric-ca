...
type ServerRequestContext interface {
	...
	GetCertificates(db.CertificateRequest, string) (*sqlx.Rows, error)
}
...
func (ctx *serverRequestContextImpl) GetCertificates(req db.CertificateRequest, callerAff string) (*sqlx.Rows, error) {
