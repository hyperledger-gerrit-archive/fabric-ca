...
func (u *DBUser) SetLevelTx(tx FabricCATx, level int) error {
	return u.setLevel(tx, level)
}

func (u *DBUser) setLevel(tx FabricCATx, level int) (err error) {
...
func (u *DBUser) ModifyAttributesTx(tx FabricCATx, newAttrs []api.Attribute) error {
...
func (u *DBUser) modifyAttributes(tx FabricCATx, newAttrs []api.Attribute) error {
...
func NewDBUser(userRec *UserRecord, db *DB) *DBUser {
	var user = new(DBUser)
