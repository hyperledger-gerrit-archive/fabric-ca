...
func updateIdentitiesTable(tx *sqlx.Tx, args ...interface{}) error {
	...
	if identityLevel < 1 {
		...
		_, err = tx.Exec("INSERT INTO users SELECT * FROM users_old")
		if err != nil {
			return err
		}
	}
...
func updateAffiliationsTable(tx *sqlx.Tx, args ...interface{}) error {
	...
	if affiliationLevel < 1 {
		...
		_, err = tx.Exec("INSERT INTO affiliations SELECT * FROM affiliations_old")
		if err != nil {
			return err
		}
	}
...
func updateCertificatesTable(tx *sqlx.Tx, args ...interface{}) error {
	...
	if certificateLevel < 1 {
		...
		_, err = tx.Exec("INSERT INTO certificates SELECT * FROM certificates_old")
		if err != nil {
			return err
		}
	}
