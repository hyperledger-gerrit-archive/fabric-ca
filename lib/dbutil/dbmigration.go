...
type dbMigrator interface {
	migrateTable(db *sqlx.DB, tableName string, curLevel int) error
}

func migrateDB(db *sqlx.DB, srvLevels *Levels) error {
...
func (m sqliteMigrator) migrateTable(db *sqlx.DB, tableName string, curLevel int) error {
	switch tableName {
	case "users":
...
func (m mysqlMigrator) migrateTable(db *sqlx.DB, tableName string, curLevel int) error {
...
func (m postgresMigrator) migrateTable(db *sqlx.DB, tableName string, curLevel int) error {
