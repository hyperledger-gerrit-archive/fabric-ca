...
import (
	...
	"github.com/hyperledger/fabric-ca/lib/db"
...
func getCertReq(id, serial, aki string, notrevoked, notexpired bool, revokedTimeStart, revokedTimeEnd, expiredTimeStart, expiredTimeEnd *time.Time) *db.CertificateRequestImpl {
	return &db.CertificateRequestImpl{
		ID:               id,
		SerialNumber:     serial,
		Aki:              aki,
