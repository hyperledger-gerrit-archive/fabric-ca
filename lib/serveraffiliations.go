...
func processStreamingAffiliationRequest(ctx *serverRequestContextImpl, caname string, caller userregistry.User) (interface{}, error) {
...
func processAffiliationRequest(ctx *serverRequestContextImpl, caname string, caller userregistry.User) (interface{}, error) {
	log.Debug("Processing affiliation configuration update request")
...
func processGetAllAffiliationsRequest(ctx *serverRequestContextImpl, caller userregistry.User, caname string) (*api.AffiliationResponse, error) {
...
func processGetAffiliationRequest(ctx *serverRequestContextImpl, caller userregistry.User, caname string) (*api.AffiliationResponse, error) {
...
func getAffiliations(ctx *serverRequestContextImpl, caller userregistry.User, caname string) (*api.AffiliationResponse, error) {
	log.Debug("Requesting all affiliations that the caller is authorized view")
	var err error

	registry := ctx.ca.registry
	callerAff := cadbuser.GetUserAffiliation(caller)
...
func getAffiliation(ctx *serverRequestContextImpl, caller userregistry.User, requestedAffiliation, caname string) (*api.AffiliationResponse, error) {
...
func processAffiliationDeleteRequest(ctx *serverRequestContextImpl, caname string) (*api.AffiliationResponse, error) {
	...
	callerAff := cadbuser.GetUserAffiliation(ctx.caller)
...
func getResponse(result *userregistry.DbTxResult, caname string) (*api.AffiliationResponse, error) {
	resp := &api.AffiliationResponse{CAName: caname}
...
func fillAffiliationInfo(info *api.AffiliationInfo, name string, result *userregistry.DbTxResult, affiliations []spi.Affiliation) error {
	info.Name = name
...
func getIDInfo(user userregistry.User) (*api.IdentityInfo, error) {
	...
	return &api.IdentityInfo{
		ID:             user.GetName(),
		Type:           user.GetType(),
		Affiliation:    cadbuser.GetUserAffiliation(user),
