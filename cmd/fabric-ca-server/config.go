...
###########################################################################
idemix:
  # Name of the issuer public key file. It will be stored in the home directory of the CA
  issuerpublickeyfile: IssuerPublicKey

  # Name of the issuer secret key. It will be stored in the <CA Home>/msp/keystore directory of the CA
  issuersecretkeyfile: IssuerSecretKey
