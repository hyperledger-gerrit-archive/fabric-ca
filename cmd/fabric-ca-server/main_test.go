...
func TestErrors(t *testing.T) {
	...
	errorCases := []TestData{
		...
		{[]string{cmdName, "start", "--csr.key.algo", "fakeAlgo"}, "Invalid algorithm: fakeAlgo"},
		{[]string{cmdName, "start", "--csr.key.algo", "ecdsa", "--csr.key.size", "12345"}, "Invalid ECDSA key size: 12345"},
