...
// Tests for the getDefaultCAName function
func TestDefaultCAName(t *testing.T) {
	t.Logf("Default ca.name for hostname 'server1.acme.com': %s", getDefaultCAName("server1.acme.com"))
	t.Logf("Default ca.name for hostname 'server1.net1.acme.com': %s", getDefaultCAName("server1.net1.acme.com"))
	t.Logf("Default ca.name for hostname 'server2': %s", getDefaultCAName("server2"))
	// Invalid hostnames
	t.Logf("Default ca.name for hostname 'foo.': %s", getDefaultCAName("foo."))
	t.Logf("Default ca.name for hostname '.': %s", getDefaultCAName("."))
	t.Logf("Default ca.name for hostname '.com': %s", getDefaultCAName(".com"))
}
