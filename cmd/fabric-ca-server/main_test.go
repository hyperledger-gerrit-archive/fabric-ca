...
func TestErrors(t *testing.T) {
	...
	errorCases := []TestData{
		...
		{[]string{cmdName, "start", "-c", ymlWithoutCAName, "-b", "user:pass"}, "ca.name property is required but is missing from the configuration file"},
	}
	...
	// "raleigh.ibm.com", as ca.name is a required property for server to start
	viper.SetDefault("ca.name", "raleigh.ibm.com")
}
