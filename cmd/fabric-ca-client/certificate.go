...
type certificateArgs struct {
	statusArgs certListArgs
	list       api.GetCertificatesRequest
}

type certListArgs struct {
	// Don't return expired certificates
	NotExpired bool `help:"Don't return expired certificates"`
	// Don't return revoked certificates
	NotRevoked bool `help:"Don't return revoked certificates"`
	// Don't return active certificates
	NotActive bool `help:"Don't return active certificates"`
...
func (c *ClientCmd) newListCertificateCommand() *cobra.Command {
	...
	util.RegisterFlags(c.myViper, flags, &c.dynamicCertificate.statusArgs, nil)
