...
func TestEnroll(t *testing.T) {
	...
	err := RunMain([]string{cmdName, "enroll", "-d", "--url", "http://0.0.0.0:7054"})
	fmt.Println("err: ", err)
	if err == nil {
	...
	err = RunMain([]string{cmdName, "enroll", "--url", "http://0.0.0.0:7054", "-u", "foo:bar"})
	if err != nil {
...
func TestReenroll(t *testing.T) {
	...
	err = RunMain([]string{cmdName, "reenroll", "--url", "http://0.0.0.0:7054"})
	if err != nil {
...
func TestRegister(t *testing.T) {
	...
	err = RunMain([]string{cmdName, "register", "--url", "http://0.0.0.0:7054", "-f", "regRequest.json"})
	if err != nil {
...
func TestRevoke(t *testing.T) {
	...
	err = RunMain([]string{cmdName, "revoke", "--url", "http://0.0.0.0:7054"})
	if err != nil {
