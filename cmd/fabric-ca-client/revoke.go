...
func init() {
	...
	util.FlagString(revokeFlags, "serial", "s", "", "Serial Number (Optional)")
	util.FlagString(revokeFlags, "aki", "a", "", "AKI (Optional)")
	util.FlagInt(revokeFlags, "reason", "r", 0, "Reason for revoking")
}
