...
var (
	rootCmd         = &cobra.Command{Use: cmdName, Short: longName}
...
func init() {
	...
	util.FlagString(pflags, "server", "s", "http://localhost:7054", "URL of the Fabric-ca server")

	// configInit is called when cobra is initialized
