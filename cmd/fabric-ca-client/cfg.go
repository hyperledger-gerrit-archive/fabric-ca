...
func (c *ClientCmd) runCfg(cmd *cobra.Command) error {
	log.Debugf("Entered runCfg, requesting server configuration updates - %+v", c.clientCfg.ServerCfg)
