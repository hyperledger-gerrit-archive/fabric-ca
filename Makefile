...
build/docker/$(PROJECT_NAME)-fvt/start.sh:
	mkdir -p build/docker/$(PROJECT_NAME)-fvt/
	cp images/$(PROJECT_NAME)-fvt/start.sh build/docker/$(PROJECT_NAME)-fvt/start.sh
