...
#   - release - builds binaries for the host platform
#   - release-all - builds binaries for all target platforms
...
IMAGES = $(PROJECT_NAME) $(PROJECT_NAME)-orderer $(PROJECT_NAME)-peer $(PROJECT_NAME)-tools golang-cc
...
release/linux-ppc64le: DOCKER_ARCH=	
