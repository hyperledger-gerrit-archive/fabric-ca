...
```
# fabric-ca client enroll -config CLIENT-CONFIG-FILE admin adminpw http://localhost:8888
```
...
```
# fabric-ca client reenroll -config CLIENT-CONFIG-FILE http://localhost:8888
```
...
```
# fabric-ca client reenroll -config CLIENT-CONFIG-FILE http://localhost:8888 ../testdata/csr.json
```
...
```
# fabric-ca client register -config CLIENT-CONFIG-FILE ../testdata/registerrequest.json http://localhost:8888
```
