...
const (
	...
	clientCmdName = "fabric-ca-client"
	serverCmdName = "fabric-ca-server"
)
...
func CreateClientHome() (string, error) {
	...
	home := filepath.Dir(GetDefaultConfigFile(clientCmdName))
...
func getDefaultDir(envs []string) string {
