...
::
    ...
    Flags:
      ...
      -H, --home string                               Server's home directory (default "/etc/hyperledger/fabric-ca")
          --idemix.issuerpublickeyfile string         Name of the file that contains marshalled bytes of CA's Idemix public key (default "IssuerPublicKey")
          --idemix.issuersecretkeyfile string         Name of the file that contains CA's Idemix secret key (default "IssuerSecretKey")
