...
::
    ...
    Flags:
      ...
      -n, --ca.name string                            Certificate Authority name
          ...
          --crl.certexpirationwindow int              This value in seconds is used to adjust current time to account for clock skews when querying for unexpired revoked certificates to include in the CRL generated by the gencrl request (default 10)
          --crl.expiry int                            Expiration (in days) for the CRL generated by the gencrl request (default 1)
