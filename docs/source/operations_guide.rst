...
You will copy the certifccate from this MSP and move it to the orderer's MSP under the
``admincerts`` folder.
...
to join the channel. This artifact will be need to transferred to all peers
...
.. code:: bash
   ...
   peer channel join -b /tmp/hyperledger/org1/peer2/assets/mychannel.block
...
``/tmp/hyperledger/org1/peer1/assets/chaincode``. From Org1's CLI container, you will
...
.. code:: bash
   ...
   export CORE_PEER_ADDRESS=peer1-org1:7051
   export CORE_PEER_MSPCONFIGPATH=/tmp/hyperledger/org1/admin/msp
   peer chaincode install -n mycc -v 1.0 -p /tmp/hyperledger/org1/peer1/assets/chaincode 
...
``/tmp/hyperledger/org2/peer1/assets/chaincode``. From Org2's CLI container, you will
execute the following command:
...
.. code:: bash
   ...
   export CORE_PEER_ADDRESS=peer1-org2:7051
   export CORE_PEER_MSPCONFIGPATH=/tmp/hyperledger/org2/admin/msp
   peer chaincode install -n mycc -v 1.0 -p /tmp/hyperledger/org2/peer1/assets/chaincode 
