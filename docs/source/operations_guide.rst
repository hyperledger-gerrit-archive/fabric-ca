...
certificate of the CA. For more information on how to use this command, please refer to: `getcainfo command <https://hyperledger-fabric-ca.readthedocs.io/en/latest/users-guide.html#Getting-a-CA-certificate-chain-from-another-Fabric-CA-server>`__.
