...
is variable and will be different everytime a key is generated. The last item is ``cert.pem``,
...
You can find more information in the `(Hyperledger Fabric documentation)[https://hyperledger-fabric.readthedocs.io/en/release-1.4/configtx.html?channel-configuration-configtx]`
...
, please refer to: `(certificate command)[users-guide.rst#listing-certificate-information]`
...
certificate of the CA. For more information on how to use this command, please refer to: `(getcainfo command)[users-guide.rst#Getting-a-CA-certificate-chain-from-another-Fabric-CA-server]`
...
Download this `[chaincode](https://github.com/hyperledger/fabric-samples/tree/master/chaincode/abac/go)`
