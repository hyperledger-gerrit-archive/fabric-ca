...
.. code:: bash
    ...
    fabric-ca-client identity add --id user1 --secret user1pw --type user --affiliation . --maxenrollments 1 --attrs hf.Revoker=true
...
To update the maxenrollments value to be 0 for an identity (i.e. use CA's max enrollment value).
The modify request must specify '-2' as the value for maxenrollments
...
.. code:: bash
    ...
    fabric-ca-client identity remove --id user1
