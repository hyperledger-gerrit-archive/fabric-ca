...
::
    ...
    Flags:
      ...
      -d, --debug                        Enable debug level logging
          ...
          --id.attr stringSlice          A list of attributes of the form <name>=<value> (e.g. hf.Revoker=true)
...
::
    ...
    # export FABRIC_CA_CLIENT_HOME=$HOME/fabric-ca/clients/admin
    # fabric-ca-client register --id.name admin2 --id.type user --id.affiliation org1.department1 --id.attr hf.Revoker=true --id.attr foo=bar
