...
The expired certificates that a caller can delete:
...
The following command shows how to delete certificates using various filters.
...
Delete all expired certificates for a specific id (user1):

.. code:: bash

 fabric-ca-client certificate delete --id user1

Delete a specific expired certificate with the AKI and serial number:

.. code:: bash

 fabric-ca-client certificate delete --serial 1234 --aki 1234

Delete a specific expired certificate owned by a specific ID and the given AKI and serial number:
