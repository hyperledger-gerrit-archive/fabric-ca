...
during certain period. The created CRL is stored in the `<msp folder>/crls/crl.pem` file.
...
.. code:: bash
    ...
    fabric-ca-client gencrl --caname "" --revokedafter 2017-09-13T16:39:57-08:00 --revokedbefore 2017-09-21T16:39:57-08:00 -c ~/clientconfig -M ~/msp
...
The `--revokedafer` and `--revokedbefore` flags specify the lower and upper boundaries of a time period.
