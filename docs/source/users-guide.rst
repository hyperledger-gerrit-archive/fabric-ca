 ...
 3. The registrar can register a user with attributes if all of the following conditions
    are satisfied:
      ...
      - Registering custom attributes (i.e. any attribute whose name does not begin with 'hf.')
        requires that the registrar has 'hf.Registar.Attributes' attribute with the value of
        ...
        beginning with "a.b.". Another example, if registrar has hf.Registrar.Attributes=orgAdmin,
        then the registrar can only register an identity with 'orgAdmin' attribute.
