...
type RevocationRequest struct {
	...
	Type string `json:"type,omitempty" help:"Allows specification of what is to be revoked. The default is 'all'"`
...
type AllRevocationResponse struct {
	X509Revocation   RevocationResponse           `json:"x509"`
	IdemixRevocation idemixapi.RevocationResponse `json:"idemix"`
}
