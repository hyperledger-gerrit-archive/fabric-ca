...
type GetCertificatesRequest struct {
	...
	Revoked TimeRange // Get revoked certificates between the specified time range
	Expired TimeRange // Get expired certificates between the specified time range
	CAName  string    // Name of CA to send request to within the server
}
