...
type EnrollmentRequest struct {
	...
	Hosts string `json:"hosts,omitempty" component:"client server" command:"enroll reenroll" help:"Comma-separated host list"`
...
type RevocationRequest struct {
	...
	Name string `json:"id,omitempty" component:"client" command:"revoke" help:"Identity whose certificates should be revoked"`
	// Serial number of the certificate to be revoked
	// If this is omitted, then Name must be specified
	Serial string `json:"serial,omitempty" component:"client" command:"revoke" help:"Serial number of the certificate to be revoked"`
	// AKI (Authority Key Identifier) of the certificate to be revoked
	AKI string `json:"aki,omitempty" component:"client" command:"revoke" help:"AKI (Authority Key Identifier) of the certificate to be revoked"`
	...
	Reason string `json:"reason,omitempty" component:"client" command:"revoke" help:"Reason for revocation"`
	// CAName is the name of the CA to connect to
	CAName string `skip:"true"`
}
...
type CSRInfo struct {
	CN           string               `json:"CN" component:"client server"`
	Names        []csr.Name           `json:"names,omitempty"`
	Hosts        []string             `json:"hosts,omitempty" component:"client server"`
	KeyRequest   *csr.BasicKeyRequest `json:"key,omitempty"`
	CA           *csr.CAConfig        `json:"ca,omitempty"`
	SerialNumber string               `json:"serial_number,omitempty" component:"client server"`
}
