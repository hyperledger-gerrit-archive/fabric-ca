...
type EnrollmentRequest struct {
	...
	Profile string `json:"profile,omitempty" component:"client server" command:"enroll" help:"Name of the signing profile to use in issuing the certificate"`
	// Label is the label to use in HSM operations
	Label string `json:"label,omitempty" component:"client server" command:"enroll" help:"Label to use in HSM operations"`
	// CSR is Certificate Signing Request info
	CSR *CSRInfo `json:"csr,omitempty" component:"client server" command:"enroll" help:"Certificate Signing Request info"`
	// CAName is the name of the CA to connect to
	CAName string `skip:"true"`
}
...
type ReenrollmentRequest struct {
	// Profile is the name of the signing profile to use in issuing the certificate
	Profile string `json:"profile,omitempty" component:"client server" command:"reenroll" help:"Name of the signing profile to use in issuing the certificate"`
	// Label is the label to use in HSM operations
	Label string `json:"label,omitempty" component:"client server" command:"reenroll" help:"Label to use in HSM operations"`
	// CSR is Certificate Signing Request info
	CSR *CSRInfo `json:"csr,omitempty" component:"client server" command:"reenroll" help:"Certificate Signing Request info"`
	// CAName is the name of the CA to connect to
	CAName string `skip:"true" component:"client server" command:"reenroll"`
}
...
type CSRInfo struct {
	CN           string               `json:"CN" component:"client server" help:"The common name field of the certificate signing request to a parent fabric-ca-server"`
	Names        []csr.Name           `json:"names,omitempty"`
	Hosts        []string             `json:"hosts,omitempty" component:"client server" help:"A list of space-separated host names in a certificate signing request to a parent fabric-ca-server"`
	KeyRequest   *csr.BasicKeyRequest `json:"key,omitempty"`
	CA           *csr.CAConfig        `json:"ca,omitempty"`
	SerialNumber string               `json:"serial_number,omitempty" component:"client server" help:"The serial number in a certificate signing request to a parent fabric-ca-server" `
}
