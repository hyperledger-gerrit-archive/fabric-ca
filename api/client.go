...
// IdemixRevocationRequest is a revocation request for a single Idemix credential or all Idemix credentials
// associated with an identity.
...
// IdemixRevocationResponse represents response from the server for an Idemix revocation request
type IdemixRevocationResponse struct {
